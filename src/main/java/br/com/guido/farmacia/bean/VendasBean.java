...
import br.com.guido.farmacia.domain.Venda;
...
public class VendasBean implements Serializable {
	...
	public void salvar() {
		try {
			...
			Messages.addGlobalError("Ocorreu um erro ao tentar finalizar essa venda");
			erro.printStackTrace();
		}
	}
}
