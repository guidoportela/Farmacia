...
public class EstadoBean implements Serializable {
	...
	@PostConstruct // chamado depois q o estadoBean(construtor) for criado
	public void listar() {
		try {
	...
	public void editar(ActionEvent evento) {
		estado = (Estado) evento.getComponent().getAttributes().get("estadoSelecionado"); // captura o estado
